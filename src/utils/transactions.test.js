...
describe('calculateRewards', () => {
  it('returns 0 if price is less than 50', () => {
    expect(calculateRewards(49)).toBe(0);
  });

  it('subtracts 50 if price is between 50 and 100', () => {
    expect(calculateRewards(75)).toBe(25);
  });

  it('calculates correctly if price is over 100', () => {
    expect(calculateRewards(120)).toBe(90);
  });
});

describe('calculatePoints', () => {
  it('calculates customer rewards for multiple transactions', () => {
    const transactions = [
  ...
  it('aggregates rewards correctly across multiple months', () => {
    const transactions = [
